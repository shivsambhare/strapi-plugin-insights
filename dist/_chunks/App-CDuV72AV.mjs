...
import { Main, Flex, Typography, Badge, Button, Box, Loader } from "@strapi/design-system";
import { ArrowClockwise, Database, Graph, TrendUp, ChartPie } from "@strapi/icons";
import styled, { keyframes } from "styled-components";
import { b as PluginIcon, a as PLUGIN_VERSION, P as PLUGIN_ID } from "./index-DRImE1yz.mjs";
...
const HomePage = () => {
  ...
  return /* @__PURE__ */ jsx(Main, { padding: 6, background: "neutral100", children: /* @__PURE__ */ jsxs(PageShell, { children: [
    /* @__PURE__ */ jsx(Hero, { children: /* @__PURE__ */ jsxs(Flex, { justifyContent: "space-between", alignItems: "center", gap: 4, wrap: "wrap", children: [
      ...
      /* @__PURE__ */ jsx(Button, { startIcon: /* @__PURE__ */ jsx(ArrowClockwise, {}), variant: "secondary", onClick: fetchSummary, disabled: isLoading, children: "Refresh" })
    ] }) }),
    ...
    isLoading ? /* @__PURE__ */ jsx(Panel, { children: /* @__PURE__ */ jsx(PanelInner, { children: /* @__PURE__ */ jsx(Flex, { justifyContent: "center", padding: 8, children: /* @__PURE__ */ jsx(Loader, { children: "Loading insights" }) }) }) }) : /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsxs(ChartGrid, { children: [
      ...
      /* @__PURE__ */ jsxs(DetailGrid, { children: [
        /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(Panel, { children: /* @__PURE__ */ jsx(PanelInner, { children: /* @__PURE__ */ jsxs(Flex, { direction: "column", gap: 4, alignItems: "stretch", children: [
